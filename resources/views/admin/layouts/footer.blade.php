            ...
            <footer class="footer text-center">
                     ...
                     <div class="tab-content" id="pills-tabContent">
                                 ...
                                 <li>
                                     <div class="message-center chat-scroll">
                                         <a href="javascript:void(0)" class="message-item" id='chat_user_1' data-user-id='1'>
                                             <span class="user-img"> <img src="{{ url('assets/admin') }}/assets/images/users/1.jpg" alt="user" class="rounded-circle"> <span class="profile-status online pull-right"></span> </span>
                                         ...
                                         <a href="javascript:void(0)" class="message-item" id='chat_user_2' data-user-id='2'>
                                             <span class="user-img"> <img src="{{ url('assets/admin') }}/assets/images/users/2.jpg" alt="user" class="rounded-circle"> <span class="profile-status busy pull-right"></span> </span>
                                             <div class="mail-contnet">
                                         ...
                                         <a href="javascript:void(0)" class="message-item" id='chat_user_3' data-user-id='3'>
                                             <span class="user-img"> <img src="{{ url('assets/admin') }}/assets/images/users/3.jpg" alt="user" class="rounded-circle"> <span class="profile-status away pull-right"></span> </span>
                                             <div class="mail-contnet">
                                         ...
                                         <a href="javascript:void(0)" class="message-item" id='chat_user_4' data-user-id='4'>
                                             <span class="user-img"> <img src="{{ url('assets/admin') }}/assets/images/users/4.jpg" alt="user" class="rounded-circle"> <span class="profile-status offline pull-right"></span> </span>
                                             <div class="mail-contnet">
                                         ...
                                         <a href="javascript:void(0)" class="message-item" id='chat_user_5' data-user-id='5'>
                                             <span class="user-img"> <img src="{{ url('assets/admin') }}/assets/images/users/5.jpg" alt="user" class="rounded-circle"> <span class="profile-status offline pull-right"></span> </span>
                                             <div class="mail-contnet">
                                         ...
                                         <a href="javascript:void(0)" class="message-item" id='chat_user_6' data-user-id='6'>
                                             <span class="user-img"> <img src="{{ url('assets/admin') }}/assets/images/users/6.jpg" alt="user" class="rounded-circle"> <span class="profile-status offline pull-right"></span> </span>
                                             <div class="mail-contnet">
                                         ...
                                         <a href="javascript:void(0)" class="message-item" id='chat_user_7' data-user-id='7'>
                                             <span class="user-img"> <img src="{{ url('assets/admin') }}/assets/images/users/7.jpg" alt="user" class="rounded-circle"> <span class="profile-status offline pull-right"></span> </span>
                                             <div class="mail-contnet">
                                         ...
                                         <a href="javascript:void(0)" class="message-item" id='chat_user_8' data-user-id='8'>
                                             <span class="user-img"> <img src="{{ url('assets/admin') }}/assets/images/users/8.jpg" alt="user" class="rounded-circle"> <span class="profile-status offline pull-right"></span> </span>
                                             <div class="mail-contnet">
                         ...
                         <div class="tab-pane fade p-15" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
                             ...
                             <div class="steamline">
                                 ...
                                 <div class="sl-item">
                                     <div class="sl-left"> <img class="rounded-circle" alt="user" src="{{ url('assets/admin') }}/assets/images/users/2.jpg"> </div>
                                     <div class="sl-right">
                                 ...
                                 <div class="sl-item">
                                     <div class="sl-left"> <img class="rounded-circle" alt="user" src="{{ url('assets/admin') }}/assets/images/users/1.jpg"> </div>
                                     <div class="sl-right">
                                 ...
                                 <div class="sl-item">
                                     <div class="sl-left"> <img class="rounded-circle" alt="user" src="{{ url('assets/admin') }}/assets/images/users/4.jpg"> </div>
                                     <div class="sl-right">
                                         <div class="font-medium">Go to the Doctor <span class="sl-date">5 minutes ago</span></div>
                                         <div class="desc">Contrary to popular belief</div>
                                     </div>
                                 ...
                                 <div class="sl-item">
                                     <div class="sl-left"> <img class="rounded-circle" alt="user" src="{{ url('assets/admin') }}/assets/images/users/6.jpg"> </div>
                                     <div class="sl-right">
                                         <div><a href="javascript:void(0)">Stephen</a> <span class="sl-date">5 minutes ago</span></div>
                                         <div class="desc">Approve meeting with tiger</div>
                                     </div>
             ...
             <!--chartjs -->
             <script src="{{ url('assets/admin') }}/assets/libs/chart.js/dist/Chart.min.js"></script>
             <script src="{{ url('assets/admin') }}/dist/js/pages/dashboards/dashboard1.js"></script>
            <!--Datatable -->
            <script src="{{ url('assets/admin') }}/assets/extra-libs/DataTables/datatables.min.js"></script>
